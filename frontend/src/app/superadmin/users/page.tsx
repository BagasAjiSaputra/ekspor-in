    ...
    <div className="max-w-7xl mx-auto pb-10">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-2 text-[15px] max-w-3xl">
          Kelola semua akun pengguna yang terdaftar di platform Eksporin. Anda dapat melihat, menghapus, atau mem-ban pengguna yang melanggar aturan.
        </p>
      </div>
      ...
      <div className="bg-[#F6F7F6] rounded-[24px] p-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-3">
            <Users className="text-green-700 h-6 w-6" />
