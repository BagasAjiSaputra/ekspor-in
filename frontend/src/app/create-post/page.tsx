                        ...
                        <div className="bg-[#F8F9F7] rounded-[40px] p-10 border border-gray-100 shadow-sm">
                            ...
                            <form className="space-y-8">
                                <div className="space-y-3">
                                    ...
                                    <div className="border-2 border-dashed border-gray-200 rounded-[24px] p-8 flex flex-col items-center justify-center gap-3 hover:border-primary/30 hover:bg-white transition-all cursor-pointer group">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest ml-1">Komoditas</label>
                                        <div className="relative">
                                            <select className="w-full bg-gray-200/50 border border-transparent rounded-[24px] py-4 px-6 text-sm font-bold text-gray-700 focus:outline-none focus:bg-white focus:border-primary/30 transition-all appearance-none">
                                                <option>Pilih Komoditas</option>
                                                <option>Padi Ciherang</option>
                                                <option>Jagung Pipil</option>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-gray-200/50 border border-transparent rounded-[24px] py-4 px-6 text-sm font-bold text-gray-700 focus:outline-none focus:bg-white focus:border-primary/30 transition-all"
                                        />
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                type="text"
                                                placeholder="0"
                                                className="w-full bg-gray-200/50 border border-transparent rounded-[24px] py-4 pl-14 pr-6 text-sm font-bold text-gray-700 focus:outline-none focus:bg-white focus:border-primary/30 transition-all"
                                            />
                                        </div>
                                    </div>
                                    <div className="space-y-3">
                                ...
                                <div className="space-y-3">
                                    <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest ml-1">Kontak WhatsApp Terintegrasi</label>
                                    <div className="relative group">
                                        <div className="absolute left-6 top-1/2 -translate-y-1/2 text-[#237127]">
                                ...
                                <button className="w-full bg-[#237127] hover:bg-[#1b5e1e] text-white py-5 rounded-[24px] font-bold flex items-center justify-center gap-3 shadow-lg shadow-green-900/10 transition-all hover:-translate-y-1 active:translate-y-0 mt-4">
                                    <Upload size={20} />
